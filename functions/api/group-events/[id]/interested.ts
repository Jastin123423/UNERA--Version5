...
/* =========================================================
   POST /api/group-events/:id/interested
   body: { action: "interested" | "remove" }  (default: "interested")
   ========================================================= */
export const onRequestPost: PagesFunction<Env> = async ({ request, env, params }) => {
  try {
    ...
    const rawAction = String(body.action ?? "interested").trim().toLowerCase();
    const isAdd = ["interested", "add"].includes(rawAction);
