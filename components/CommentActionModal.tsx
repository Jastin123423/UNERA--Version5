      ...
      >
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                <span className="text-[#F8FAFC] font-bold text-sm truncate">{authorName}</span>
                {isHidden && (
              ...
              <p className="text-[#94A3B8] text-xs">Discussion options</p>
            </div>
          </div>
        ...
        <div className="p-3 space-y-1.5 overflow-y-auto">
          ...
          {canDelete && !isConfirmingDelete && (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-rose-400 font-semibold text-sm">Delete Discussion</div>
                <div className="text-[#94A3B8] text-xs">Permanently remove this discussion</div>
              </div>
            </button>
          )}
            ...
            <div className="p-3.5 bg-rose-500/10 border border-rose-500/30 rounded-xl space-y-3 animate-in fade-in duration-150">
              ...
              <div className="flex items-center gap-2 pt-1">
                <button
                  ...
                  className="flex-1 py-2 rounded-lg bg-[#1E293B] hover:bg-[#27354D] text-[#CBD5E1] text-xs font-semibold transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2 rounded-lg bg-rose-600 hover:bg-rose-500 text-white text-xs font-semibold flex items-center justify-center gap-1.5 shadow-lg shadow-rose-600/30 transition-colors"
                >
          ...
          {onReply && !isConfirmingDelete && (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[#F8FAFC] font-semibold text-sm">Reply to Discussion</div>
                <div className="text-[#94A3B8] text-xs">Post a reply to {authorName}</div>
              </div>
            </button>
          )}
          ...
          {commentText && !isConfirmingDelete && (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[#94A3B8] text-xs">Copy discussion text</div>
              </div>
            </button>
          )}
        ...
        <div className="p-3 border-t border-[#1E293B] bg-[#0A0F1D]">
          <button
            type="button"
            onClick={onClose}
            className="w-full py-2.5 rounded-xl bg-[#1E293B] hover:bg-[#27354D] text-[#CBD5E1] font-semibold text-sm transition-colors"
          >
            Cancel
          </button>
        </div>
